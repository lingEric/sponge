...
// This example uses ConsumerDispatcher, a simple synchronous wrapper over a
// Consumer to allow processing messages using pattern matching rather than
// writing a loop and check if there's a message, if there's an error, etc.
